...
public class ex07 {
    public static void main(String[] args){
        ...
        String l = cursor.nextLine();

        System.out.print("What is the width of the room in feet? ");
        String w = cursor.nextLine();

        System.out.println("You entered dimensions of " + l + " feet by " + w + " feet.");

        System.out.println("The area is");

        int areaFeet = Integer.parseInt(l) * Integer.parseInt(w);
        System.out.println(areaFeet + " square feet");

        double formulaConstant = 0.09290304;
        double areaMeters = areaFeet * formulaConstant;
        System.out.println(areaMeters + " square meter");
    }
}
